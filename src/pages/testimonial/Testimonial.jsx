  ...
  return (
    <section id="testimonials" className="relative py-14">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="container max-w-5xl mx-auto sm:text-center md:mx-auto">
          <h3 className="text-white text-3xl sm:text-5xl font-bold text-center">
            Hear What{" "}
            <span className="bg-gradient-to-r from-[#C1842D] to-[#ECC974] text-transparent bg-clip-text font-medium">
              Rizz
            </span>{" "}
        ...
        <div className="mt-12">
          ...
          >
            {testimonials.map((item, idx) => (
              <SwiperSlide key={idx}>
                <div className="bg-gray-400/30 rounded-xl shadow-md h-full">
                  <div className="p-4">
                    <svg
                  ...
                  <figure>
                    ...
                    <div className="flex items-center justify-center gap-x-2">
                      <Star className="text-[#C1842D]" />
                      <Star className="text-[#C1842D]" />
                      <Star className="text-[#C1842D]" />
                      <Star className="text-[#C1842D]" />
                      <Star className="text-gray-400" />
                    </div>
                    <div className="flex items-center gap-x-4 p-4 mt-6 justify-center">
                      <img
                        src={item.avatar}
          ...
          {/* Add the custom pagination container */}
